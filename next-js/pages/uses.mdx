...
([A1863, 64GB, Space Gray](https://support.apple.com/kb/sp767))
...
([64GB, Gold](https://support.apple.com/kb/sp725))
...
([802.11ac, 5th Generation, 2TB](https://support.apple.com/kb/sp679))
...
[gsuite.google.com](https://gsuite.google.com/)
...
[voice.google.com](https://voice.google.com/)
...
[google.com/maps/timeline](https://www.google.com/maps/timeline)
...
[![Yubico FIDO U2F Security Key](/assets/life-stack/yubico-fido-u2f-security-key.jpg)](https://www.yubico.com/products/yubikey-hardware/fido-u2f-security-key/)
...
[![Yubico Yubikey 4C Security Key](/assets/life-stack/yubico-yubikey-4c-security-key.jpg)](https://www.yubico.com/product/yubikey-4-series/#yubikey-4c)
...
[spotify.com/us/premium](https://www.spotify.com/us/premium/)
...
[hbonow.com](https://play.hbonow.com/)
...
[schwab.com](http://content.schwab.com/web/retail/public/get-started/checking/)

#### **Ally Bank** savings account

![Ally Bank savings account](/assets/life-stack/ally-bank-savings-account.jpg)

My primary savings account. Ally Bank's interest rates for their Online Savings Account product are higher than most others (although now there are some new products coming out from big banks like Barclays or Goldman Sachs that are offering slightly higher rates). Ally is fully online so they have a good app and website. I keep my [3-6 month emergency fund](https://www.nerdwallet.com/blog/banking/life-build-emergency-fund/) in this account and move anything else to [Betterment](#betterment) if this account is healthy.

[ally.com/bank/online-savings-account/](https://www.ally.com/bank/online-savings-account/)
...
[ynab.com](https://ynab.com/referral/?ref=_npmBwcIqzqvCqNP) (affiliate link, get 34 days + 1 month free)
...
I use these while I commute and they're awesome. I found them on [Wirecutter](https://thewirecutter.com/reviews/best-bluetooth-headphones/). These headphones can pair with multiple devices, and can also be plugged in and used as normal wired headphones. The controls are also very easy to use. Overall, thoughtful features and design, and they sound great for the price.
...
[obagonline.com](https://www.obagonline.com/O-clock-watches-s/1817.htm)
...
Dentist told me to buy an electric toothbrush so I'd stop scrubbing my gums away. It's relatively cheap (compared to other models) but nothing special. I found it on [Wirecutter](https://thewirecutter.com/reviews/best-electric-toothbrush/).
...
([A1723, 64GB, Space Gray](https://support.apple.com/kb/sp738))
...
([Retina, 13-inch, Late 2013](https://support.apple.com/kb/sp691))
...
Brooklyn Academy of Music (BAM) membership was a solid choice for discounted movie tickets before I got [MoviePass](#moviepass). I was a member for a free year with [IDNYC](http://www1.nyc.gov/site/idnyc/index.page), then for a paid year after that, but I chose not to renew it this year. BAM is still my preferred movie theater but MoviePass is going to give everyone a run for their money when it comes to movie subscriptions.

[bam.org](http://bam.org)
